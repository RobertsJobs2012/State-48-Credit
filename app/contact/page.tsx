              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">
                      <a href="tel:+16023776626" className="hover:text-copper-default transition-colors">(602) 377-6626</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">
                      <a href="mailto:State48Credit@gmail.com" className="hover:text-copper-default transition-colors">State48Credit@gmail.com</a>
                    </p>
                  </div>
                </div>
