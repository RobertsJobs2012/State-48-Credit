      ...
      <section className="py-20 bg-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm font-medium text-text-secondary">
            <span className="px-4 py-2 bg-sunken border border-border-default rounded-full">15,892 Negative Items Removed Across Arizona</span>
            <span className="px-4 py-2 bg-sunken border border-border-default rounded-full">Collections · Repossessions · Bankruptcies · Foreclosures · Inquiries · Identity Theft</span>
            <span className="px-4 py-2 bg-sunken border border-border-default rounded-full">Serving Phoenix · Tucson · Mesa · Chandler · Gilbert · Yuma · Glendale and All of Arizona</span>
