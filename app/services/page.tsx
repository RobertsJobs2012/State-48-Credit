      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { name: 'Inquiry Removal', price: '$149', desc: 'Removes unauthorized hard inquiries from all 3 bureaus', emoji: '🔍' },
              { name: 'ChexSystems Removal', price: '$199', desc: 'Removes entries blocking banking access', emoji: '🏦' },
              { name: 'Innovis Removal', price: '$79', desc: 'Clears Innovis report entries', emoji: '📋' },
              { name: '24-Hour Rush', price: '$99', desc: 'Disputes drafted and submitted within 24 hours', emoji: '⚡' },
            ].map((a, i) => (
              <div key={i} className="gradient-border-card shimmer rounded-2xl p-6 overflow-hidden hover:scale-[1.02] transition-transform duration-300">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-2xl">{a.emoji}</span>
                  <span className="text-2xl font-display font-bold text-turquoise-default">{a.price}</span>
                </div>
