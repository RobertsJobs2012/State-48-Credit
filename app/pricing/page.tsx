...
export const metadata: Metadata = {
  title: 'Credit Repair Cost Phoenix AZ | Pricing | State 48 Credit',
  description: 'State 48 Credit offers flat-fee credit repair in Arizona — no monthly billing. Packages from $299 with a 100% money-back guarantee. See exact pricing.',
};
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="glass-panel rounded-[20px] p-8 flex flex-col">
                <div className="flex gap-0.5 mb-4 text-sm">⭐⭐⭐⭐⭐</div>
      ...
      <section className="py-32 relative overflow-hidden noise-overlay dot-grid">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-6">
            <Link href="/get-started" className="btn-primary text-lg group w-full sm:w-auto">Get My Free Credit Analysis ↗</Link>
