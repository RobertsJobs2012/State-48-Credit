      ...
      <section className="py-20 bg-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm font-medium text-text-secondary">
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">2,041</span>
              Arizona Clients Helped Since 2010
            </div>
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">15,892</span>
              Negative Items Deleted Across All Three Bureaus
            </div>
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">$20M+</span>
              in Total Debt Removed
            </div>
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">150+</span>
              Average Score Increase
            </div>
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">14–30</span>
              Days Until First Results Often Appear
            </div>
            <div className="p-6 bg-card border border-copper-default/10 rounded-2xl hover:border-copper-default/25 transition-all">
              <span className="block text-3xl font-display font-extrabold text-copper-default mb-2 tracking-tight drop-shadow-[0_0_12px_rgba(196,98,45,0.15)]">4.9</span>
