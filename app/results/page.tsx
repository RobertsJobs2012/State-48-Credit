      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          ...
          {[
            ...
            <div key={i} className="gradient-border-card shimmer rounded-[24px] p-6 md:p-12 mb-8 overflow-hidden">
              <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 mb-6">
                <h3 className="text-xl md:text-2xl font-display font-bold">{cs.name}</h3>
