        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-12">
            ...
            <div className="glass-panel p-8 md:p-10 rounded-2xl relative">
              ...
              <div className="ml-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                  <h3 className="text-2xl font-bold text-text-headline">YOU: Book Your Free Consultation</h3>
            ...
            <div className="glass-panel p-8 md:p-10 rounded-2xl relative">
              ...
              <div className="ml-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                  <h3 className="text-2xl font-bold text-text-headline">WE: Build Your Custom Strategy and Begin Disputes</h3>
            ...
            <div className="glass-panel p-8 md:p-10 rounded-2xl relative">
              ...
              <div className="ml-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                  <h3 className="text-2xl font-bold text-text-headline">WE: Follow Through Until the Job Is Done</h3>
            ...
            <div className="glass-panel p-8 md:p-10 rounded-2xl relative border-copper-default/30">
              ...
              <div className="ml-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                  <h3 className="text-2xl font-bold text-text-headline">YOU: Watch Your Score Climb and Get Back to Living</h3>
