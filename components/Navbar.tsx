      ...
      <header className={`sticky top-0 z-50 transition-all duration-500 -mb-[80px] ${isScrolled ? 'py-3' : 'py-5'}`}>
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative z-10">
          <Link href="/" className="flex items-center gap-3 z-50 group">
            <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-copper-default to-copper-pressed flex items-center justify-center shadow-[0_4px_16px_rgba(196,98,45,0.3)] group-hover:shadow-[0_4px_20px_rgba(196,98,45,0.4)] transition-shadow duration-300">
