  ...
  return (
    <section className="py-28 bg-alt-bg relative overflow-hidden noise-overlay">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="mt-12 text-center"><Link href="/results" className="inline-flex items-center gap-2 text-turquoise-default font-sans font-semibold hover:text-turquoise-hover transition-colors text-base">View credit repair results from real Arizona clients →</Link></div>
      </div>
    </section>
  );
}
