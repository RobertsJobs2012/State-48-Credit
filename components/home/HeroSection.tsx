...
import { ArrowUpRight, Star, Shield, Zap, ChevronDown } from 'lucide-react';
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center pt-20 pb-16 overflow-hidden">
      {/* ── ATMOSPHERIC BACKGROUND (exact spec gradient) ── */}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(196,98,45,0.10) 0%, transparent 70%)' }}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(43,191,179,0.06) 0%, transparent 70%)' }}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-[1.15fr_0.85fr] gap-20 items-center">
        {/* Left: Copy — left-aligned, generous space */}
        <div className="max-w-2xl">
          ...
          >
            <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.06]">
              ...
              <span className="text-[11px] font-sans font-semibold text-turquoise-default tracking-wide uppercase">Arizona&apos;s #1 Rated</span>
            </div>
          ...
          {/* Headline — staggered line-by-line clip reveal */}
          <h1 className="text-[clamp(2.8rem,5.5vw,4.5rem)] font-display font-extrabold text-text-headline leading-[1.06] tracking-[-0.04em] mb-7">
            {headlineLines.map((line, i) => (
              <span key={i} className="block overflow-hidden">
                <motion.span
                  ...
                  className={`block ${line.accent ? 'text-gradient-copper-turquoise' : ''}`}
                >
                  {line.text}
                </motion.span>
              </span>
          ...
          {/* CTAs — slide up after subheadline */}
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="flex gap-12 pt-8 border-t border-border-default"
          >
            <div>
        ...
        >
          ...
          {/* Floating social proof badge — glassmorphism pill */}
          <motion.div
            ...
            className="absolute -bottom-4 -left-8 glass-panel rounded-2xl px-5 py-3.5 flex items-center gap-3 z-20"
          >
            {/* Stacked avatars */}
            ...
            <div>
              ...
              <p className="text-[11px] font-sans font-semibold text-text-secondary">2,041 happy clients</p>
            </div>
          </motion.div>
        </motion.div>
      </div>

      {/* Scroll cue — animated line drawing downward */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
