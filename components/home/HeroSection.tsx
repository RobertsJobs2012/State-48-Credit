...
export function HeroSection() {
  return (
    <section className="relative min-h-[100vh] flex items-center pt-20 pb-16 overflow-hidden">
      ...
      <motion.div className="absolute top-[-15%] left-[-5%] w-[55%] h-[55%] rounded-full z-0 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(196,98,45,0.15) 0%, transparent 70%)' }} animate={{ x: [0, 40, 0], y: [0, 25, 0], scale: [1, 1.08, 1] }} transition={{ duration: 18, repeat: Infinity, ease: "linear" }} />
