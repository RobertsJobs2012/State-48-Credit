    ...
    <section className="py-36 relative overflow-hidden noise-overlay dot-grid">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <p className="text-base text-text-secondary font-sans leading-[1.7] mb-14 max-w-2xl mx-auto">State 48 Credit has helped 2,041 Arizona residents — from Phoenix to Tucson, from Mesa to Yuma — remove the items blocking their financial future. The first step is free. Results can begin in as little as 14 days.</p>
