    ...
    <section className="py-28 bg-sunken relative overflow-hidden noise-overlay">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <div className="mt-10 text-center">
          <Link href="/faq" className="inline-flex items-center gap-2 text-turquoise-default font-sans font-semibold hover:text-turquoise-hover transition-colors text-base">Read our most frequently asked credit repair questions →</Link>
        </div>
      </div>
    </section>
  );
