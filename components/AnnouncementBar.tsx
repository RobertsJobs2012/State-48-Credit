      ...
      <div className="bg-gradient-to-r from-[#1E1712] via-[#211914] to-[#1E1712] relative overflow-hidden">
        ...
        <div className="py-3 relative">
          <div className="flex overflow-hidden">
            <div className="flex shrink-0 animate-[marquee_35s_linear_infinite] gap-0">
            ...
            <div className="flex shrink-0 animate-[marquee_35s_linear_infinite] gap-0" aria-hidden>
              {[...items, ...items, ...items].map((text, i) => (
