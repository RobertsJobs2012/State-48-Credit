            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex gap-3 pt-2">
                {[{ emoji: '𝕏', l: 'Facebook' }, { emoji: '📸', l: 'Instagram' }, { emoji: '💼', l: 'LinkedIn' }].map(({ emoji, l }) => (
                  <a key={l} href="#" className="w-9 h-9 rounded-xl bg-white/[0.03] border border-border-default flex items-center justify-center text-text-muted hover:bg-copper-default hover:text-background hover:border-copper-default transition-all duration-200 text-sm" aria-label={l}>
                    {emoji}
                  </a>
                ))}
              </div>
